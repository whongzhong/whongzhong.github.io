...
>
> 更多内容请参考<a href="http://ant.apache.org/manual/Tasks/junit.html" target="_blank">apache Ant JUnit官方文档</a>
...
**junitreport** 定义一个junitreport task，用于输出相关的测试结果。这个东西我没有仔细研究，其可以将前面生成的xml测试报告转换成html格式。更多内容请看<a href="http://ant.apache.org/manual/Tasks/junitreport.html">JunitReport</a>
